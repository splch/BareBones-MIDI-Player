! function(e) {
    ...
    try {
        ...
        var X = n();
        X.majorVersion <= 6 ? x = "none" : (window.AudioContext = window.AudioContext || window.webkitAudioContext, T = new AudioContext, x = "WebAudioAPI");
        e.MIDIjs.set_logging = function(e) {
            ...
            return W;
        }, "WebAudioAPI" == x ? (t(C, function() {}), e.MIDIjs.play = u, e.MIDIjs.stop = p, W = "audioMethod: WebAudioAPI, sampleRate (Hz): " + T.sampleRate + ", audioBufferSize (Byte): " + B, e.MIDIjs.noteOn = m, e.MIDIjs.startSynth = f) : "bgsound" == x ? (e.MIDIjs.play = v, e.MIDIjs.stop = _, W = "audioMethod: &lt;bgsound&gt;") : "object" == x ? (e.MIDIjs.play = y, e.MIDIjs.stop = D, W = "audioMethod: &lt;object&gt;") : (e.MIDIjs.play = function(e) {}, e.MIDIjs.stop = function(e) {}, W = "audioMethod: No method found"), "WebAudioAPI" == x && (a(F + "pat/arachno-127.pat"), a(F + "pat/MT32Drums/mt32drum-41.pat"), a(C)), e.MIDIjs.initError = null;
    }
    catch (J) {
